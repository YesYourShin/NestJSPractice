...
class BoardStatusValidationPipe {
    constructor() {
        this.StatusOptions = [board_status_enum_1.BoardStatus.PRIVATE, board_status_enum_1.BoardStatus.PRIVATE];
    }
    transform(value) {
        value = value.toUpperCase();
        if (!this.isStatusValid(value)) {
            throw new common_1.BadRequestException(`${value} isn't in the status`);
        }
        return value;
    }
